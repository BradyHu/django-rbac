...
from .utils import find_namespace
...
class KetoRelationTuples(models.Model):
    ...
    subject_set_object = models.CharField(max_length=255, blank=True, null=True)
    subject_set_relation = models.CharField(max_length=255, blank=True, null=True)
